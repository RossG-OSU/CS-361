...
'''
Here is the dynamic part of the emailing...
'''
receiver_lis = 'email_list.csv'
with open('dangerfile.txt') as f:
    body = f.read()
subject = 'Avvy Report for ' + today
#print(body)
...
GOOGLE_CLIENT_ID = '454000385880-0di3ba3e7bffe240mjn0rqqs8d30430o.apps.googleusercontent.com'
GOOGLE_CLIENT_SECRET = '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'
GOOGLE_REFRESH_TOKEN = '1//06aEmQ6yZksd3CgYIARAAGAYSNwF-L9Ir71l35oVGk4_OvBdvpewoKma3idPMqXWRnSdFhzEbjSXjPAhOew64RbRks00vDnx9mQg'
...
if __name__ == '__main__':
    if GOOGLE_REFRESH_TOKEN is None:
        ...
        exit()
        '''pulling data from imported csv'''
    with open(receiver_lis, 'r') as file:
        csvread = csv.reader(file)
        header = next(csvread)
        for row in csvread:
            receiver = row[0]
            send_mail('avvyreport@gmail.com', receiver, subject, body)